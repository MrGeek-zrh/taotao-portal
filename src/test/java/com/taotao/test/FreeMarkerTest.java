...
public class FreeMarkerTest {
	...
	* @throws Exception
	...
	public void testFreeMarker() throws Exception {
		...
		configuration.setDirectoryForTemplateLoading(new File("/home/mrgeek/document/workspace/JavaWorkspace/taotao-portal/src/main/webapp/WEB-INF/ftl"));
		...
		Writer out = new FileWriter(new File("/home/mrgeek/document/workspace/JavaWorkspace/taotao-portal/src/main/webapp/WEB-INF/html/hello.html"));
