...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://www.taotao.com/"><img src="/taotao-portal/images/taotao-logo.gif" alt="淘淘商城"></a></div>
</div>
<!-- /header -->
...
<form id="orderForm" class="hide">
		...
		<c:forEach items="${cartList }" var="cart" varStatus="status">
			...
			<input type="hidden" name="orderItems[${status.index}].id" value="${cart.id}"/>
		...
		<input type="hidden" name="postFree" value="0"/>
...
<div class="step-tit">
	<h3>送货清单</h3>
	<div class="extra-r">
					<a href="/taotao-portal/cart/show.html" id="cartRetureUrl" class="return-edit ftx-05">返回修改购物车</a>
			</div>
</div>
   ...
   <!--满赠套装商品-->
	 ...
	 <c:forEach items="${cartList }" var="cart">     						
        <div class="goods-item goods-item-extra">
				...
				<div class="p-img">
					<a target="_blank" href="/taotao-portal/item/${cart.id}.html"><img src="${cart.image}" alt=""></a>
				</div>
				<div class="goods-msg">					
					<div class="p-name">
...
<!-- footer end -->
	<script type="text/javascript" src="/taotao-portal/js/json2.js"></script>
	<script type="text/javascript" src="/taotao-portal/js/payAndShipment.js"></script>
	<script type="text/javascript" src="/taotao-portal/js/order2.js"></script>
	</body>
</html>