var TTCart = {
	...
	itemNumChange : function(){
		$(".increment").click(function(){//＋
			...
			$.post("/taotao-portal/cart/update/num/"+_thisInput.attr("itemId")+"/"+_thisInput.val() + ".action",function(data){
		...
		$(".quantity-form .quantity-text").change(function(){
			var _thisInput = $(this);
			$.post("/taotao-portal/cart/update/num/"+_thisInput.attr("itemId")+"/"+_thisInput.val(),function(data){
				TTCart.refreshTotalPrice();
			});
		});
	},
